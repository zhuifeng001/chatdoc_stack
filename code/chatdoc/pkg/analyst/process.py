...
LastEditTime: 2024-10-22 11:24:45
'''
import datetime
import time
from pkg.analyst.objects import Params, Context, Response
...
def process(params: Params) -> Context:
    ...
    # from .retrieve_parallel import retrieve_parallel
    ...
    # if 2 <= len(context.files) <= 5:
    #     # 并行召回
    #     context = retrieve_parallel(context)
    # else:
    #     # 召回small片段
