...
LastEditTime: 2024-09-20 16:40:37
'''


import copy
from pkg.es.es_p_doc_fragment import PDocFragmentES, PDocFragmentModel
from pkg.es.es_p_doc_item import PDocItemModel, PDocItemES
...
def fillin_doc_items_cache(doc_item_cache, user_id, uuid_ori_id_tuples: list[tuple[str, str]]) -> list[PDocItemModel]:
    '''
...
def fillin_fragment_parent_cache(fragment_cache: dict[str, PDocFragmentModel], fragments: list[PDocFragmentModel], level: int = None):
    '''
...
def fillin_fragment_children_cache(fragment_cache: dict[str, PDocFragmentModel], fragments: list[PDocFragmentModel]):
    '''
...
def get_fragment_ori_ids(fragment: PDocFragmentModel, fragment_cache: dict[str, PDocFragmentModel]):
    '''
...
def get_fragment_ori_text(fragment: PDocFragmentModel, fragment_cache: dict[str, PDocFragmentModel], doc_items_cache: dict[str, PDocItemModel]):
    '''
...
def get_fragment_all_texts(fragment: PDocFragmentModel, fragment_cache: dict[str, PDocFragmentModel], doc_items_cache: dict[str, PDocItemModel]):
    '''
...
def get_table_ori_text(doc_table: PDocTableModel, doc_ori_cache: dict[str, PDocItemModel]):
    '''
